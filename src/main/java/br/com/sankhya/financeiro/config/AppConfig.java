...
@ComponentScans(value = {
		@ComponentScan("br.com.sankhya.financeiro.dao"),
		@ComponentScan("br.com.sankhya.financeiro.service")
})
public class AppConfig {
	...
	public LocalSessionFactoryBean getSessionFactory() {
		...
		factoryBean.setPackagesToScan("br.com.sankhya.financeiro.model");
